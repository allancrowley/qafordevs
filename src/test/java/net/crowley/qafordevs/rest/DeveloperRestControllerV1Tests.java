package net.crowley.qafordevs.rest;

import com.fasterxml.jackson.databind.ObjectMapper;
import net.crowley.qafordevs.dto.DeveloperDto;
import net.crowley.qafordevs.entity.DeveloperEntity;
import net.crowley.qafordevs.exceptions.DeveloperNotFoundException;
import net.crowley.qafordevs.exceptions.DeveloperWithDuplicateEmailException;
import net.crowley.qafordevs.service.DeveloperService;
import net.crowley.qafordevs.util.DataUtils;
...
public class DeveloperRestControllerV1Tests {
    ...
    public void givenDeveloperDto_whenCreateDeveloper_thenSuccessResponse() throws Exception {
        ...
        BDDMockito.given(developerService.saveDeveloper(any(DeveloperEntity.class))).willReturn(entity);
        //when
        ResultActions result = mockMvc.perform(post("/api/v1/developers").contentType(MediaType.APPLICATION_JSON)
    ...
    public void givenDeveloperDtoWithDuplicatedEmail_whenCreateDeveloper_thenErrorResponse() throws Exception {
        //given
        DeveloperDto dto = DataUtils.getJohnDoeDtoTransient();
    ...
    public void givenDeveloperDto_whenUpdateDeveloper_thenSuccessResponse() throws Exception {
        ...
        DeveloperEntity entity = DataUtils.getJohnDoePersisted();
        BDDMockito.given(developerService.updateDeveloper(any(DeveloperEntity.class))).willReturn(entity);
        //when
