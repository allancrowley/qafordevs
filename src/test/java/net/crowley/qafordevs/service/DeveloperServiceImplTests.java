...
import net.crowley.qafordevs.exceptions.*;
...
public class DeveloperServiceImplTests {
    ...
    public void givenId_whenSoftDeleteById_thenRepositorySaveIsCalled() {
        //given
        BDDMockito.given(developerRepository.findById(anyInt()))
                .willReturn(Optional.of(DataUtils.getJohnDoePersisted()));
        //when
    ...
    public void givenCorrectId_whenHardDeleteById_thenRepositorySaveIsCalled() {
        //given
        BDDMockito.given(developerRepository.findById(anyInt()))
                .willReturn(Optional.of(DataUtils.getJohnDoePersisted()));
        //when
